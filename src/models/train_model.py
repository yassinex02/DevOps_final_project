...
if __name__ == "__main__":
    ...
    parser.add_argument("--numerical_cols", nargs='+', required=True, help="List of numerical column names")
    parser.add_argument("--factorize_cols", nargs='+', required=True, help="List of columns to apply FactorizeTransformer")
