...
if __name__ == "__main__":
    ...
    parser.add_argument("--numerical_cols", type=json.loads, required=True, help="JSON string of numerical column names")
    parser.add_argument("--factorize_cols", type=json.loads, required=True, help="JSON string of columns to apply FactorizeTransformer")
