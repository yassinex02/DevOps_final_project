...
def run_shap_analysis(model: LogisticRegression, X_test: pd.DataFrame, instance_index: int):
    ...
    try:
        ...
        force_plot_path = os.path.join("reports", f"shap_force_plot_{instance_index}.png")
        shap.force_plot(
...
def extract_feature_importance(model: LogisticRegression, X: pd.DataFrame):
    ...
    try:
        ...
        logging.error(f"An error occurred while extracting feature importance: {e}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_artifact", type=str, required=True, help="The MLflow model artifact to test")
    parser.add_argument("--X_test_artifact", type=str, required=True, help="The test features artifact")
    parser.add_argument("--y_test_artifact", type=str, required=True, help="The test labels artifact")
    parser.add_argument("--instance_index", type=int, required=True, help="The index of the instance to explain")
    parser.add_argument("--reports_artifact", type=str, required=True, help="Name of the reports artifact to log to W&B")
